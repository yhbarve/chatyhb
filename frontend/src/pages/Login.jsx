...
export default function Login(){
    ...
    async function handleLogin(){
        ...
        navigate('https://chatyhb-api.vercel.app/user/chat/' + response.data.id);
    }
        ...
        <div>
            ...
            <div className="flex gap-20 flex-col justify-start items-center h-screen pt-72">
                ...
                <div className="flex flex-col gap-5 w-2/3 xl:w-1/4 items-center">
                    ...
                    <div classname="text-center">Don't have an account? <a href="https://chatyhb-api.vercel.app/user/signup" className="underline">Sign up</a> here</div>
                </div>
            </div>
        </div>
    )
